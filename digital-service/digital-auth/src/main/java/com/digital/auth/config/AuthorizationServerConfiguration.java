...
import com.digital.auth.support.CustomeOAuth2AccessTokenGenerator;
import com.digital.auth.support.core.CustomeOAuth2TokenCustomizer;
import com.digital.auth.support.core.FormIdentityLoginConfigurer;
import com.digital.auth.support.core.PigDaoAuthenticationProvider;
import com.digital.auth.support.filter.PasswordDecoderFilter;
import com.digital.auth.support.filter.ValidateCodeFilter;
import com.digital.auth.support.handler.PigAuthenticationFailureEventHandler;
import com.digital.auth.support.handler.PigAuthenticationSuccessEventHandler;
import com.digital.auth.support.password.OAuth2ResourceOwnerPasswordAuthenticationConverter;
import com.digital.auth.support.password.OAuth2ResourceOwnerPasswordAuthenticationProvider;
import com.digital.auth.support.sms.OAuth2ResourceOwnerSmsAuthenticationConverter;
import com.digital.auth.support.sms.OAuth2ResourceOwnerSmsAuthenticationProvider;
...
public class AuthorizationServerConfiguration {
	...
	@ConditionalOnProperty(value = "security.micro", havingValue = "true")
