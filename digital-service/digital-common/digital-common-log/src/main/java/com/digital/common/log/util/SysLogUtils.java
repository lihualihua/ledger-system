...
package com.digital.common.log.util;
...
import com.digital.common.core.servlet.RepeatBodyRequestWrapper;
import com.digital.common.core.util.SpringContextHolder;
import com.digital.common.log.config.PigLogProperties;
import com.digital.common.log.event.SysLogEventSource;
...
public class SysLogUtils {
	...
	public SysLogEventSource getSysLog() {
		...
		Map<String, String[]> paramsMap = MapUtil.removeAny(parameterMap,
