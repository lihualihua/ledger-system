...
import com.digital.common.feign.PigFeignAutoConfiguration;
...
public class PigFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
	...
	private final static String BASE_URL = "http://127.0.0.1:${server.port}${server.servlet.context-path}${spring.controller.path.prefix:/api}";
