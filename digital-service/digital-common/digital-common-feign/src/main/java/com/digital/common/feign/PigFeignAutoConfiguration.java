...
package com.digital.common.feign;

import com.alibaba.cloud.sentinel.feign.SentinelFeignAutoConfiguration;
import com.alibaba.csp.sentinel.adapter.spring.webmvc.callback.BlockExceptionHandler;
import com.alibaba.csp.sentinel.adapter.spring.webmvc.callback.RequestOriginParser;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.digital.common.feign.core.PigFeignInnerRequestInterceptor;
import com.digital.common.feign.core.PigFeignRequestCloseInterceptor;
import com.digital.common.feign.sentinel.ext.PigSentinelFeign;
import com.digital.common.feign.sentinel.handle.PigUrlBlockHandler;
import com.digital.common.feign.sentinel.parser.PigHeaderRequestOriginParser;
import feign.Feign;
