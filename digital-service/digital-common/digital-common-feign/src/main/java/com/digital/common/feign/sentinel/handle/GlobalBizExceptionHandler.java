...
package com.digital.common.feign.sentinel.handle;
...
/**
 * <p>
 * 全局异常处理器结合sentinel 全局异常处理器不能作用在 oauth server <a href="https://gitee.com/log4j/pig/issues/I1M2TJ">...</a>
 * </p>
 *
 * @author lengleng
 * @date 2020-06-29
...
public class GlobalBizExceptionHandler {
	...
	public R handleGlobalException(Exception e) {
		...
		// 业务异常交由 sentinel 记录
//		Tracer.trace(e);
		return R.failed("服务器内部异常，请联系管理员!");
	}
	...
	@ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
	public R handleApplicationException(Exception e) {
	...
	public R handleMaxUploadSizeExceededException(Exception e) {
		log.error("上传异常信息 ex={}", e.getMessage(), e);
		return R.failed("上传的文件过大，请联系管理员上传!");
	}

	@ExceptionHandler(CheckedException.class)
	@ResponseStatus(HttpStatus.OK)
	public R handleCheckedException(Exception e) {
		log.error("系统异常信息 ex={}", e.getMessage(), e);
		return R.failed(e.getMessage());
	}
