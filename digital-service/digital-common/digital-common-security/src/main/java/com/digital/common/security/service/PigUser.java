...
public class PigUser extends User implements OAuth2AuthenticatedPrincipal {
	 ...
	 */
	@Getter
	@JsonIgnoreProperties({"createBy", "updateBy", "createTime", "updateTime", "parentId", "delFlag"})
	...
	@Getter
	@JsonIgnoreProperties({"createBy", "updateBy", "createTime", "updateTime", "delFlag"})
	private final List<SysRole> roles;

	public PigUser(Long id, SysDept deptId, String username, String password, String phone, boolean enabled,
                   boolean accountNonExpired, boolean credentialsNonExpired, boolean accountNonLocked,
                   Collection<? extends GrantedAuthority> authorities, String displayName, List<SysRole> roles) {
